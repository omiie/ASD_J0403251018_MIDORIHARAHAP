...
#--------------------------------------------------------------------------- 
#Implementasi Quick Sort (Descending)
#--------------------------------------------------------------------------- 

#cara kerja: menggunakan metode divide and conquer, yaitu membagi masalah menjadi bagian yang lebih kecil, mengurutkannya, lalu menggabungkannya kembali.
#quick sort: memilih satu elemen sebagai pivot, kemudian membagi data menjadi dua bagian
